    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            // h-hotel account
            $mail->Username='tengkorakgila366@gmail.com';
            $mail->Password='#Mahabarata1999';

            // send by h-hotel email
            $mail->setFrom('tengkorakgila366@gmail.com', 'Password Reset');
            // get email from input
            $mail->addAddress($_POST["email"]);
            //$mail->addReplyTo('tengkorakgila366@gmail.com');
